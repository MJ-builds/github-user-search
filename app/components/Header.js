...
export const Header = () => {
  ...
  return (
    <div className="flex flex-column pt-2 pb-8 justify-between items-center min-w-[350px] md:w-[730px] md:h-[38px] ">
      <div className="text-2xl font-bold text-[#222731] dark:text-[#ffffff]">devfinder</div>
      <div className="hover:text-[#222731]">
        {/* changing theme and icons */}
        <button onClick={toggleTheme}>
          {theme === "light" ? (
            <div className="text-sm font-bold flex gap-4 items-center hover:text-[#222731]">
              DARK
              <svg
                className=""
                width="20"
            ...
            <div className="text-sm font-bold flex gap-4 items-center hover:text-[#90A4D4] ">
              LIGHT
